function Set-IPAddress {
                param(  [string]$networkinterface =$(read-host "Enter the name of the NIC (ie Local Area Connection)"),
                        [string]$ip = $(read-host "Enter an IP Address (ie 10.38.8.144)"),
                ...
                $index = (Get-WmiObject Win32_NetworkAdapter | Where-Object {$_.netconnectionid -eq $networkinterface}).InterfaceIndex
